// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BaseApplyCategorySitecoreIdForAddBlock.cs" company="Sitecore Corporation">
...
namespace Feature.Catalog.Engine.Pipelines.Blocks
{
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName(CatalogConstants.Pipelines.Blocks.BaseApplyCategorySitecoreIdForAdd)]
    public abstract class BaseApplyCategorySitecoreIdForAddBlock : PipelineBlock<EntityView, EntityView, CommercePipelineExecutionContext>
    {
        ...
        public BaseApplyCategorySitecoreIdForAddBlock(CommerceCommander commander)
            : base(null)
        {
