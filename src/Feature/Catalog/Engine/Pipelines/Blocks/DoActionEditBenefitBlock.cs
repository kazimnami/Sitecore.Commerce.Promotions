...
namespace Feature.Catalog.Engine.Pipelines.Blocks
{
    ...
    public class DoActionEditBenefitBlock : PipelineBlock<EntityView, EntityView, CommercePipelineExecutionContext>
    {
        ...
        public override async Task<EntityView> Run(EntityView entityView, CommercePipelineExecutionContext context)
        {
            if (string.IsNullOrEmpty(entityView?.Action)
                    || !entityView.Action.Equals(context.GetPolicy<KnownPromotionsActionsPolicy>().EditBenefit, StringComparison.OrdinalIgnoreCase)
