// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetPromotionQualificationDetailsViewBlock.cs" company="Sitecore Corporation">
...
namespace Feature.Catalog.Engine.Pipelines.Blocks
{
    ...
    /// <summary>Defines the get promotion qualification details view pipeline block</summary>
    /// <seealso>
    ///     <cref>
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName(CatalogConstants.Pipelines.Blocks.GetPromotionQualificationDetailsView)]
    public class GetPromotionQualificationDetailsViewBlock : PipelineBlock<EntityView, EntityView, CommercePipelineExecutionContext>
    {
        ...
        public GetPromotionQualificationDetailsViewBlock(CommerceCommander commander)
          : base(null)
        {
        ...
        public override async Task<EntityView> Run(EntityView entityView, CommercePipelineExecutionContext context)
        {
            ...
            if (string.IsNullOrEmpty(entityViewArgument?.ViewName)
                    || !entityViewArgument.ViewName.Equals(context.GetPolicy<KnownPromotionsViewsPolicy>().QualificationDetails, StringComparison.OrdinalIgnoreCase))
            {
                return await Task.FromResult(entityView);
            }

            var isEditAction = entityViewArgument.ForAction.Equals(context.GetPolicy<KnownPromotionsActionsPolicy>().EditQualification, StringComparison.OrdinalIgnoreCase);
