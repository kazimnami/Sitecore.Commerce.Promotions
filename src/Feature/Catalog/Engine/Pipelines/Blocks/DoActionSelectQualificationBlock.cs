// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DoActionSelectQualificationBlock.cs" company="Sitecore Corporation">
...
namespace Feature.Catalog.Engine.Pipelines.Blocks
{
    ...
    /// <summary>Defines the select qualification action pipeline block</summary>
    /// <seealso>
    ///     <cref>
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName(CatalogConstants.Pipelines.Blocks.DoActionSelectQualification)]
    public class DoActionSelectQualificationBlock : PipelineBlock<EntityView, EntityView, CommercePipelineExecutionContext>
    {
        ...
        public override async Task<EntityView> Run(EntityView entityView, CommercePipelineExecutionContext context)
        {
            ...
            if (string.IsNullOrEmpty(entityView?.Action)
                    || !entityView.Action.Equals(context.GetPolicy<KnownPromotionsActionsPolicy>().SelectQualification, StringComparison.OrdinalIgnoreCase))
            {
