...
{
    [EntityIdentifier(nameof(CartItemQuantityXSellPriceAction))]
    public class CartItemQuantityXSellPriceAction : CartTargetItemId, ICartLineAction
    {
        ...
        public void Execute(IRuleExecutionContext context)
        {
            ...
            foreach (var line in lines)
            {
                ...
                line.Adjustments.Add(new CartLineLevelAwardedAdjustment()
                {
                    ...
                    IsTaxable = false,
                    AwardingBlock = nameof(CartItemQuantityXSellPriceAction)
                });
                ...
                line.GetComponent<MessagesComponent>().AddMessage(
                    ...
                    $"PromotionApplied: {propertiesModel?.GetPropertyValue("PromotionId") ?? nameof(CartItemQuantityXSellPriceAction)}");
            }
        }
    }
}
