    ...
    public class ConfigureSitecore : IConfigureSitecore
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Sitecore().Pipelines(config => config
                ...
                .AddPipeline<Pipelines.IInitialisePromotionsPipeline, Pipelines.InitialisePromotionsPipeline>(pipeline => pipeline
                    .Add<Pipelines.Blocks.InitializeEnvironmentPromotionsBlock>()
                )
            );
